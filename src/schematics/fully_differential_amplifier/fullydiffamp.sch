...
N -100 80 -50 80 {lab=#net1}
N -100 50 -100 80 {lab=#net1}
N -300 50 -100 50 {lab=#net1}
N -300 50 -300 70 {lab=#net1}
N -300 70 -300 80 {lab=#net1}
N 140 60 270 60 {lab=#net2}
N 270 40 270 60 {lab=#net2}
N 270 40 390 40 {lab=#net2}
N 390 100 390 120 {lab=#net6}
...
C {res.sym} -300 110 0 1 {name=R1
value=530
footprint=1206
device=resistor
m=1}
C {res.sym} 390 70 0 1 {name=R2
value=530
footprint=1206
device=resistor
m=1}
C {capa.sym} -300 170 0 0 {name=C1
m=1
value=0.1p
footprint=1206
