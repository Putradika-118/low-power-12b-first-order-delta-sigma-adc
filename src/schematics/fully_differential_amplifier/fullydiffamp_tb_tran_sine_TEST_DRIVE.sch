...
N 330 -42.5 330 -39.0625 {lab=vop}
N 330 20.9375 330 28.75 {lab=GND}
N 341.25 -18.75 341.25 -13.75 {lab=vom}
N 341.25 -13.75 380.9375 -13.75 {lab=vom}
N 440.9375 -13.75 448.75 -13.75 {lab=GND}
...
C {lab_wire.sym} 341.25 -18.75 0 1 {name=p2 sig_type=std_logic lab=vom}
...
C {vsource.sym} 15 140 0 0 {name=V6 value="SINE(1.65 10u 2k 0 0 0)" savecurrent=false}
...
C {noconn.sym} 346.25 -18.75 1 0 {name=l2}
C {capa.sym} 330 -9.0625 0 0 {name=C1
m=1
value=5p
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} 330 28.75 0 0 {name=l9 lab=GND}
C {capa.sym} 410.9375 -13.75 3 0 {name=C2
m=1
value=5p
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} 448.75 -13.75 0 0 {name=l10 lab=GND}
